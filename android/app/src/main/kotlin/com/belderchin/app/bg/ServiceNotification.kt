...
import com.belderchin.app.Application
import com.belderchin.app.MainActivity
import com.belderchin.app.R
import com.belderchin.app.Settings
import com.belderchin.app.constant.Action
import com.belderchin.app.constant.Status
//import com.belderchin.app.utils.CommandClient
import com.hiddify.core.libbox.Libbox
import com.belderchin.app.Application.Companion.notification
import com.belderchin.app.utils.GrpcClientProvider
    ...
    fun show(profileName: String, @StringRes contentTextId: Int) {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Application.notification.createNotificationChannel(
                NotificationChannel(
                    notificationChannel, "Belderchin VPN service", NotificationManager.IMPORTANCE_LOW
                )
            )
        }
