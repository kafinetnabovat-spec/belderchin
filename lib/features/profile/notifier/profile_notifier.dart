...
class FreeProfilesNotifier extends _$FreeProfilesNotifier {
  ...
  Future<List<FreeProfile>> build() async {
    // Belderchin: upstream fetched a list of "free profiles" from the Hiddify repository
    // whenever the add-profile sheet opened. We never contact third-party servers for
    // this; Belderchin's own signed source list (see lib/features/sources) is used instead.
    return <FreeProfile>[];
  }
}
